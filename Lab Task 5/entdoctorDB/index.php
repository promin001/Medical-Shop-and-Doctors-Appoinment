...
<body>
  <div class="container-fluid">
    <h2 class="text-center">Welcome To ENT Doctor's</h2>
    ...
    <div class="row">
      <div class="container">
        ...
        <?php 
             ...
             ?>
          <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-success btn-sm">Add Doctor's</a> <div><button class="modal-title" ><a href="../Doctorlist.php">Back</a>
        </div>
        <div class="row">
