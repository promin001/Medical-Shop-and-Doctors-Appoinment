...
--
-- Table structure for table `Neuromedicine`
--

DROP TABLE IF EXISTS `Neuromedicine`;
CREATE TABLE IF NOT EXISTS `Neuromedicine` (
...
--
-- Dumping data for table `Neuromedicine`
--

INSERT INTO `Neuromedicine` (`id`, `username`, `email`, `mobile`, `city`) VALUES
