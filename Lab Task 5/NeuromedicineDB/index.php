...
<body>
  <div class="container-fluid">
    <h2 class="text-center">Welcome To Neuro Medicine Doctor's</h2>
    <p class="datatable design text-center">Show Doctor's</p>
    <div class="row">
      <div class="container">
        <div class="btnAdd">
        <?php 
             ...
             ?>
          <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-success btn-sm">Add Doctor's</a> <div><button class="modal-title" ><a href="../Doctorlist.php">Back</a> </button></div>
        </div>
        <div class="row">
  ...
  <script type="text/javascript">
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      var id = $(this).data('id');
      if (confirm("Are you sure want to delete this Doctor? ")) {
        $.ajax({
          url: "delete_user.php",
          data: {
            id: id
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Update Doctor's</h5>
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="mobileField" class="col-md-3 form-label">Education</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="mobileField" name="mobile">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="cityField" class="col-md-3 form-label">Appointment Day</label>
              <div class="col-md-9">
  ...
  <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add Doctor's</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="addUser" action="">
            ...
            <div class="mb-3 row">
              <label for="addMobileField" class="col-md-3 form-label">Education</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="addMobileField" name="mobile">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="addCityField" class="col-md-3 form-label">Appointment Day</label>
              <div class="col-md-9">
